...
public class UpdateOrderAdminservlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        double Total_Cost = Double.parseDouble(request.getParameter("total"));
        ...
        od.UpdateOrderAdmin(order_id, Sender, Receiver, Origin_address, Destination_address, Sender_phone, Receiver_phone, Weight, Status, Weight, true);
